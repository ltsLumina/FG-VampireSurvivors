...
public static class Deprecated
{
    ...
    public static async Task SequenceActionsAsync(Action initialAction, double delayInSeconds, Action consequentAction, CancellationToken cancellationToken = default, bool debugLog = false)
    {
