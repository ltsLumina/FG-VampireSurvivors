...
{
    public static void FreezeConstraints(this Rigidbody2D rigidbody, Constraints constraints) => rigidbody.constraints |= (RigidbodyConstraints2D) constraints;

    public static void UnfreezeConstraints(this Rigidbody2D rigidbody, Constraints constraints) => rigidbody.constraints &= ~(RigidbodyConstraints2D) constraints;

    public static void FreezeAllConstraints(this Rigidbody2D rigidbody) => rigidbody.constraints = RigidbodyConstraints2D.FreezeAll;

    public static void UnfreezeAllConstraints(this Rigidbody2D rigidbody) => rigidbody.constraints = RigidbodyConstraints2D.None;
}
