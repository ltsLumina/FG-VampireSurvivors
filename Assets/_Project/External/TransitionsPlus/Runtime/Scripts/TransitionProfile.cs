...
namespace TransitionsPlus {
    ...
    public static class TransitionTypeExtensions {
        ...
        public static bool SupportsAspectRatio(this TransitionType type) {
            return type == TransitionType.Fade || type == TransitionType.Wipe || type == TransitionType.DoubleWipe || type == TransitionType.CrossWipe || type == TransitionType.Splash || type == TransitionType.Screen || type == TransitionType.Tiles || type == TransitionType.Shape || type == TransitionType.Circles;
        }
        ...
        public static bool SupportsCellsDivisions(this TransitionType type) {
            return type == TransitionType.Mosaic || type == TransitionType.Dissolve || type == TransitionType.Tiles || type == TransitionType.Circles;
        }
